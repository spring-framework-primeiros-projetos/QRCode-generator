...
public class BarCodesController {
    ...
    @PostMapping(value = "/barbecue/ean13/{barcode}", produces = MediaType.IMAGE_PNG_VALUE)
    ...
    @PostMapping(value = "/barcode4j/ean13/{barcode}", produces = MediaType.IMAGE_PNG_VALUE)
    ...
    @PostMapping(value = "/zxing/ean13/{barcode}", produces = MediaType.IMAGE_PNG_VALUE)
    ...
    @PostMapping(value = "/zxing/code128/{barcode}", produces = MediaType.IMAGE_PNG_VALUE)
    ...
    @PostMapping(value = "/zxing/pdf417", produces = MediaType.IMAGE_PNG_VALUE, consumes = MediaType.TEXT_PLAIN_VALUE )
    ...
    @PostMapping(value = "/zxing/qrcode", produces = MediaType.IMAGE_PNG_VALUE, consumes = MediaType.TEXT_PLAIN_VALUE)
    ...
    @PostMapping(value = "/zxing/qrcodejson")
